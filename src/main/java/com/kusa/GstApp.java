...
/**
 * This class builds and runs an engagment frame based
 * on Gst.
 *
 */
public class GstApp 
{
  public static void exec(GDriveService gds)
  {
    ...
    GstPanel middle = new GstPanel(videoPlaylist, gds);

    //make gst panel, auto loop.
    middle.getPlayBin().connect((PlayBin.ABOUT_TO_FINISH) element -> middle.playNext());
